...
public class SolarSky : CustomSky
{
	...
	public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
	{
		...
		for (int j = center; j < num; j++)
		{
			...
			{
				spriteBatch.Draw(_meteorTexture.Value, position, new Rectangle(0, num3 * (_meteorTexture.Height() / 4), _meteorTexture.Width(), _meteorTexture.Height() / 4), Color.White * num2 * _fadeOpacity, 0f, Vector2.Zero, vector4.X * 5f * _meteors[j].Scale, SpriteEffects.None, 0f);
			}
		}
	}
