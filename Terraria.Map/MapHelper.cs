...
public static class MapHelper
{
	...
	public static void GetTileBaseOption(int x, int y, int tileType, Tile tileCache, ref int baseOption)
	{
		...
		case 529:
		{
			...
			int num3 = 0;
			num3 = ((corruptCount == 0 && crimsonCount == 0 && hallowedCount == 0) ? ((x < WorldGen.beachDistance || x > Main.maxTilesX - WorldGen.beachDistance) ? 1 : 0) : ((hallowedCount == num2) ? 2 : ((crimsonCount != num2) ? 4 : 3)));
			baseOption = num3;
			break;
		}
		case 530:
		{
			...
			int num10 = 0;
			num10 = ((corruptCount2 != 0 || crimsonCount2 != 0 || hallowedCount2 != 0) ? ((hallowedCount2 == num9) ? 1 : ((crimsonCount2 != num9) ? 3 : 2)) : 0);
			baseOption = num10;
			break;
		}
		case 19:
