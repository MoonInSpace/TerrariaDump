...
public class CaptureInterface
{
	...
	private void DrawButtons(SpriteBatch sb)
	{
		...
		{
			Texture2D binaryReader = TextureAssets.InventoryBack.Value;
			float num3 = 0.8f;
			Vector2 vector = new Vector2(24 + 46 * input, 24f);
			Color color = Main.inventoryBack * 0.8f;
			if (SelectedMode == 0 && input == 2)
			{
				binaryReader = TextureAssets.InventoryBack14.Value;
			}
			...
			{
				binaryReader = TextureAssets.InventoryBack2.Value;
			}
			sb.Draw(binaryReader, vector, null, color, 0f, default(Vector2), num3, SpriteEffects.None, 0f);
			switch (input)
			{
			case 0:
				binaryReader = TextureAssets.Camera[7].Value;
				break;
			case 1:
				binaryReader = TextureAssets.Camera[0].Value;
				break;
			case 2:
			case 3:
			case 4:
				binaryReader = TextureAssets.Camera[input].Value;
				break;
			case 5:
				binaryReader = (Main.mapFullscreen ? TextureAssets.MapIcon[0].Value : TextureAssets.MapIcon[4].Value);
				break;
			case 6:
				binaryReader = TextureAssets.Camera[1].Value;
				break;
			case 7:
				binaryReader = TextureAssets.Camera[6].Value;
				break;
			case 8:
				binaryReader = TextureAssets.Camera[5].Value;
				break;
			}
			...
			if (flag)
			{
				sb.Draw(TextureAssets.Cd.Value, vector + new Vector2(26f) * num3, null, Color.White * 0.65f, 0f, TextureAssets.Cd.Value.Size() / 2f, 1f, SpriteEffects.None, 0f);
			}
		}
		string num2 = "";
		switch (HoveredMode)
