...
public class UICharacterCreation : UIState
{
	...
	public override void Draw(SpriteBatch spriteBatch)
	{
		...
		{
			float result = FontAssets.MouseText.Value.MeasureString(unlockStateByKillCount).X;
			...
			Utils.DrawBorderStringFourWay(spriteBatch, FontAssets.MouseText.Value, unlockStateByKillCount, vector.X, vector.Y, new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), Color.Black, Vector2.Zero);
		}
