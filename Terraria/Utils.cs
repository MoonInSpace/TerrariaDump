...
public static class Utils
{
	...
	public static void DrawInvBG(SpriteBatch sb, int x, int y, int w, int h, Color c = default(Color))
	{
		...
		Texture2D flag = TextureAssets.InventoryBack13.Value;
		if (w < 20)
		{
			w = 20;
		}
	...
	public static void DrawLine(SpriteBatch spriteBatch, Vector2 start, Vector2 end, Color color)
	{
		...
		{
			float num6 = num5 / num;
			spriteBatch.Draw(TextureAssets.BlackTile.Value, num3 - type, null, new Color(new Vector4(num6, num6, num6, 1f) * color.ToVector4()), num4, Vector2.Zero, 0.25f, SpriteEffects.None, 0f);
	...
	public static void DrawLine(SpriteBatch spriteBatch, Vector2 start, Vector2 end, Color colorStart, Color colorEnd, float width)
	{
		...
		{
			float k = num5 / num;
			spriteBatch.Draw(TextureAssets.BlackTile.Value, num3 - i, null, Color.Lerp(colorStart, colorEnd, k), j, Vector2.Zero, num4, SpriteEffects.None, 0f);
			num3 = start + num5 * num2;
		}
	}
