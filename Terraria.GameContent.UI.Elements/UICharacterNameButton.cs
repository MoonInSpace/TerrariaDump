...
public class UICharacterNameButton : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		Utils.DrawSplicedPanel(spriteBatch, _BasePanelTexture.Value, (int)item.X, (int)item.Y, (int)item.Width, (int)item.Height, 10, 10, 10, 10, Color.White * 0.5f);
		if (_hovered)
		{
			Utils.DrawSplicedPanel(spriteBatch, _hoveredBorderTexture.Value, (int)item.X, (int)item.Y, (int)item.Width, (int)item.Height, 10, 10, 10, 10, Color.White);
		}
	}
