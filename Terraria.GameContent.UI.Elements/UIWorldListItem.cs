...
public class UIWorldListItem : AWorldListItem
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		spriteBatch.Draw(_dividerTexture.Value, new Vector2(num, packet.Y + 21f), null, Color.White, 0f, Vector2.Zero, new Vector2((GetDimensions().X + GetDimensions().Width - num) / 8f, 1f), SpriteEffects.None, 0f);
