...
public class UIKeybindingListItem : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		ChatManager.DrawColorCodedStringWithShadow(spriteBatch, FontAssets.ItemStack.Value, GetFriendlyName(), position, value, 0f, Vector2.Zero, baseScale, i);
		position.X -= 17f;
		...
		ChatManager.DrawColorCodedStringWithShadow(spriteBatch, FontAssets.ItemStack.Value, text, position, value, 0f, Vector2.Zero, baseScale, i);
