...
public class UIDifficultyButton : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		Utils.DrawSplicedPanel(spriteBatch, _BasePanelTexture.Value, (int)num.X, (int)num.Y, (int)num.Width, (int)num.Height, item, item, num3, num3, Color.Lerp(Color.Black, _color, 0.8f) * 0.5f);
		if (num4)
		{
			Utils.DrawSplicedPanel(spriteBatch, _BasePanelTexture.Value, (int)num.X + num2, (int)num.Y + num2 - 2, (int)num.Width - num2 * 2, (int)num.Height - num2 * 2, item, item, num3, num3, Color.Lerp(_color, Color.White, 0.7f) * 0.5f);
		}
		if (_hovered)
		{
			Utils.DrawSplicedPanel(spriteBatch, _hoveredBorderTexture.Value, (int)num.X, (int)num.Y, (int)num.Width, (int)num.Height, item, item, num3, num3, Color.White);
		}
	}
