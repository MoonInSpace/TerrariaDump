...
public class CreditsRollComposer
{
	...
	private SegmentInforReport PlaySegment_GuideEmotingAtRainbowPanel(int startTime)
	{
		...
		DrawData data = new DrawData(flag.Value, Vector2.Zero, null, Color.White, 0f, flag.Size() / 2f, 0.25f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_SteampunkerRepairingCyborg(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData num2 = new DrawData(flag.Value, Vector2.Zero, num, Color.White, 0f, num.Size() * new Vector2(0.5f, 1f) + new Vector2(unscaledPosition, -42f), 1f, SpriteEffects.None);
		...
		num = flag.Frame();
		num2 = new DrawData(flag.Value, Vector2.Zero, num, Color.White, 0f, num.Size() * new Vector2(0.5f, 1f) + new Vector2(unscaledPosition, -42f), 1f, SpriteEffects.None);
		...
		DrawData b = new DrawData(firstTileY.Value, Vector2.Zero, lastTileY, Color.White, 0f, lastTileY.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		...
		DrawData tile = new DrawData(i.Value, Vector2.Zero, j, Color.White, 0f, j.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_SantaAndTaxCollectorThrowingPresents(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data = new DrawData(tile.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(item, -42f), 1f, SpriteEffects.None);
		...
		DrawData data2 = new DrawData(val.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_Grox_WitchDoctorGoingToHisPeople(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data2 = new DrawData(val.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		new DrawData(val.Value, Vector2.Zero, rectangle2, Color.White, 0f, rectangle2.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_DryadTurningToTree(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData texture2D = new DrawData(tileStyle.Value, Vector2.Zero, num, Color.White, 0f, num.Size() * new Vector2(0.5f, 1f) + new Vector2(0f, -42f), 1f, SpriteEffects.None);
		...
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_Grox_SkeletonMerchantSearchesThroughBones(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData i = new DrawData(value.Value, Vector2.Zero, value2, Color.White, 0f, value2.Size() * new Vector2(0.5f, 1f) + new Vector2(num2, -42f), 1f, SpriteEffects.None);
		...
		DrawData value3 = new DrawData(num6.Value, Vector2.Zero, null, Color.White, 0f, num6.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.None);
		...
		DrawData drawData = new DrawData(val2.Value, Vector2.Zero, null, Color.White, 0f, val2.Size() / 2f, 1f, SpriteEffects.None);
		Main.instance.LoadItem(1274);
		Asset<Texture2D> val3 = TextureAssets.Item[1274];
		DrawData drawData2 = new DrawData(val3.Value, Vector2.Zero, null, Color.White, 0f, val3.Size() / 2f, 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_MerchantAndTravelingMerchantTryingToSellJunk(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		Rectangle rectangle = val.Frame();
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(num, -42f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_GuideRunningFromZombie(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		Rectangle rectangle = val.Frame();
		DrawData data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(i, -42f), 1f, SpriteEffects.None);
		...
		rectangle = val.Frame();
		data = new DrawData(val.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(i, -42f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_AnglerAndPirateTalkAboutFish(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data = new DrawData(result.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(flameSeed, -42f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_Grox_WizardPartyGirlDyeTraderAndPainterPartyWithBunnies(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData vector = new DrawData(num4.Value, Vector2.Zero, tileFlameData, Color.White, 0f, tileFlameData.Size() * new Vector2(0.5f, 1f) + new Vector2(color, -42f), 1f, SpriteEffects.None);
		...
		DrawData num7 = new DrawData(val.Value, Vector2.Zero, num6, Color.White, 0f, num6.Size() * new Vector2(0.5f, 1f), 1f, SpriteEffects.FlipHorizontally);
	...
	private SegmentInforReport PlaySegment_TinkererAndMechanic(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData tileLight = new DrawData(origin.Value, Vector2.Zero, value, Color.White, 0f, value.Size() * new Vector2(0.5f, 1f) + new Vector2(0f, -42f), 1f, SpriteEffects.None);
	...
	private SegmentInforReport PlaySegment_ClothierChasingTruffle(int startTime, Vector2 sceneAnchorPosition)
	{
		...
		DrawData data = new DrawData(flag.Value, Vector2.Zero, rectangle, Color.White, 0f, rectangle.Size() * new Vector2(0.5f, 1f) + new Vector2(num2, -42f), 1f, SpriteEffects.None);
