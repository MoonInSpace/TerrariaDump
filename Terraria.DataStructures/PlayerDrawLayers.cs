...
public static class PlayerDrawLayers
{
	...
	public static void DrawCompositeArmorPiece(ref PlayerDrawSet drawinfo, CompositePlayerDrawContext context, DrawData data)
	{
		...
		if (context == CompositePlayerDrawContext.FrontShoulder && drawinfo.drawPlayer.head == 269)
		{
			...
			DrawData item2 = new DrawData(TextureAssets.Extra[214].Value, position2, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			item2.shader = drawinfo.cHead;
			drawinfo.DrawDataCache.Add(item2);
			item2 = new DrawData(TextureAssets.GlowMask[308].Value, position2, drawinfo.drawPlayer.bodyFrame, drawinfo.headGlowColor, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			item2.shader = drawinfo.cHead;
			drawinfo.DrawDataCache.Add(item2);
		}
	...
	public static void DrawPlayer_01_BackHair(ref PlayerDrawSet drawinfo)
	{
		if (!drawinfo.hideHair && drawinfo.backHairDraw)
		{
			...
			{
				DrawData num240 = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				num240.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(num240);
			}
			else if (drawinfo.hatHair)
			{
				DrawData num240 = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				num240.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(num240);
			}
		}
	...
	public static void DrawPlayer_03_PortableStool(ref PlayerDrawSet drawinfo)
	{
		...
		{
			Texture2D num225 = TextureAssets.Extra[102].Value;
	...
	public static void DrawPlayer_04_ElectrifiedDebuffBack(ref PlayerDrawSet drawinfo)
	{
		...
		Texture2D num223 = TextureAssets.GlowMask[25].Value;
	...
	public static void DrawPlayer_05_ForbiddenSetRing(ref PlayerDrawSet drawinfo)
	{
		if (drawinfo.drawPlayer.setForbidden && drawinfo.shadow == 0f)
		{
			...
			Texture2D type3 = TextureAssets.Extra[74].Value;
			Texture2D num203 = TextureAssets.GlowMask[217].Value;
	...
	public static void DrawPlayer_05_2_SafemanSun(ref PlayerDrawSet drawinfo)
	{
		if (drawinfo.drawPlayer.head == 238 && drawinfo.shadow == 0f)
		{
			...
			Texture2D num158 = TextureAssets.Extra[152].Value;
			Texture2D num159 = TextureAssets.Extra[152].Value;
			int num160 = 0;
	...
	public static void DrawPlayer_06_WebbedDebuffBack(ref PlayerDrawSet drawinfo)
	{
		if (drawinfo.drawPlayer.webbed && drawinfo.shadow == 0f && drawinfo.drawPlayer.velocity.Y != 0f)
		{
			...
			Texture2D num145 = TextureAssets.Extra[32].Value;
	...
	public static void DrawPlayer_08_Backpacks(ref PlayerDrawSet drawinfo)
	{
		if (DrawPlayer_08_PlayerVisuallyHasFullArmorSet(drawinfo, 266, 235, 218))
		{
			...
			num58 = num58.Floor();
			Texture2D num59 = TextureAssets.Extra[212].Value;
		...
		if (DrawPlayer_08_PlayerVisuallyHasFullArmorSet(drawinfo, 268, 237, 222))
		{
			...
			Texture2D num62 = TextureAssets.Extra[213].Value;
		...
		if (drawinfo.heldItem.type == 4818 && drawinfo.drawPlayer.ownedProjectileCounts[902] == 0)
		{
			...
			num66 = num66.Floor();
			DrawData num57 = new DrawData(TextureAssets.BackPack[tile2].Value, num66, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
			drawinfo.DrawDataCache.Add(num57);
		}
		if (drawinfo.drawPlayer.backpack > 0 && drawinfo.drawPlayer.backpack < ArmorIDs.Back.Count && !drawinfo.drawPlayer.mount.Active)
		{
			...
			num68 = num68.Floor();
			DrawData num57 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.backpack].Value, num68, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
		...
		else
		{
			...
			case 6:
			{
				DrawData num57 = new DrawData(TextureAssets.BackPack[num70].Value, num75, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
				num57.shader = num73;
				drawinfo.DrawDataCache.Add(num57);
				break;
			}
			default:
			{
				DrawData num57 = new DrawData(TextureAssets.BackPack[num70].Value, num76, new Rectangle(0, 0, TextureAssets.BackPack[num70].Width(), TextureAssets.BackPack[num70].Height()), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.BackPack[num70].Width() / 2, TextureAssets.BackPack[num70].Height() / 2), 1f, drawinfo.playerEffect);
				num57.shader = num73;
				drawinfo.DrawDataCache.Add(num57);
				break;
			}
	...
	public static void DrawPlayer_08_1_Tails(ref PlayerDrawSet drawinfo)
	{
		if (drawinfo.drawPlayer.tail > 0 && drawinfo.drawPlayer.tail < ArmorIDs.Back.Count && !drawinfo.drawPlayer.mount.Active)
		{
			...
			num53 = num53.Floor();
			DrawData num54 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.tail].Value, num53, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
	...
	public static void DrawPlayer_10_BackAcc(ref PlayerDrawSet drawinfo)
	{
		...
		num24 = num24.Floor();
		DrawData num23 = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.back].Value, num24, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
		...
		if (drawinfo.drawPlayer.back == 36)
		{
			...
			for (int i = 0; i < num28; i++)
			{
				...
				num23 = new DrawData(TextureAssets.GlowMask[332].Value, num24 + new Vector2(num27 + i * num30, 0f), num26, immuneAlpha, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect);
				num23.shader = drawinfo.cBack;
				drawinfo.DrawDataCache.Add(num23);
			}
		}
	...
	public static void DrawPlayer_09_Wings(ref PlayerDrawSet drawinfo)
	{
		...
		if (drawinfo.drawPlayer.wings == 45)
		{
			...
			if (drawinfo.shadow == 0f)
			{
				...
				{
					treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].Value, vec2.Floor() + num28.ToRotationVector2() * num27, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 6 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 6), color4, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 12), 1f, drawinfo.playerEffect);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
		...
		if (drawinfo.drawPlayer.wings == 43 && drawinfo.shadow == 0f)
		{
			...
			for (int l = 0; l < 2; l++)
			{
				treeTileType = new DrawData(position: vector11 + new Vector2((float)Main.rand.Next(-10, 10) * 0.125f, (float)Main.rand.Next(-10, 10) * 0.125f), texture: TextureAssets.GlowMask[272].Value, sourceRect: value5, color: new Color(230, 230, 230, 60), rotation: drawinfo.drawPlayer.bodyRotation, origin: origin, scale: 1f, effect: drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		}
		...
		{
			treeTileType = new DrawData(TextureAssets.GlowMask[181].Value, vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 127) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
		}
		else if (drawinfo.drawPlayer.wings == 38)
		{
			...
			treeTileType = new DrawData(TextureAssets.GlowMask[251].Value, vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color9, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
			for (int num36 = drawinfo.drawPlayer.shadowPos.Length - 2; num36 >= 0; num36--)
			{
				...
				for (float num37 = 0f; num37 < 1f; num37 += 0.01f)
				{
					...
					treeTileType = new DrawData(TextureAssets.GlowMask[251].Value, vector13 + vector12 * num37 + vector10, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color10 * (1f - num37), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
					treeTileType.shader = drawinfo.cWings;
					drawinfo.DrawDataCache.Add(treeTileType);
				}
			}
		...
		else if (drawinfo.drawPlayer.wings == 31)
		{
			...
			for (int n = 0; n < 4; n++)
			{
				...
				treeTileType = new DrawData(TextureAssets.Wings[drawinfo.drawPlayer.wings].Value, vector10.Floor() + vector14, new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color11 * drawinfo.stealth * (1f - drawinfo.shadow) * 0.5f, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
				treeTileType.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(treeTileType);
			}
		...
		{
			treeTileType = new DrawData(TextureAssets.GlowMask[183].Value, vector10.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 0) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1.06f, drawinfo.playerEffect);
			treeTileType.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(treeTileType);
		}
	}
